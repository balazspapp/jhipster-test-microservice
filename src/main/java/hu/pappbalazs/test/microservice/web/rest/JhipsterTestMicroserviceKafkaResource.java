...
@RestController
@RequestMapping("/api/jhipster-test-microservice-kafka")
public class JhipsterTestMicroserviceKafkaResource {

    private final Logger log = LoggerFactory.getLogger(JhipsterTestMicroserviceKafkaResource.class);
    ...
    public JhipsterTestMicroserviceKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
